...
def generate_cv_html(
    ...
    embed_css: bool = True,
    use_dynamic_template: bool = True,
) -> str:
    """
    ...
    # Choose template
    template_name = (
        "base_template_dynamic.html" if use_dynamic_template else "base_template.html"
    )
    ...
    if SAVE_ARTIFACTS:
        output_name = (
            f"templates/resume_{style_name}.html"
            if style_name != "default"
            else "templates/resume.html"
        )
